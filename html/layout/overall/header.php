  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div class="top-bar">
		<a href="register.php">
							...
							CarcooIzxOT 10.95 Will Start In: <span style="color: yellow;" id="countdown">loading...</span>
							<?php
							} else {
								echo 'CarcooIzxOT 10.95 Will Start In: <span style="color: yellow;">SERVER STARTED!</span>';
							}
							?>
		</a>
	</div>
							...
							<ul>
								...
								<li><a href="killers.php">Killers</a></li>
									<?php //if ($config['guildwar_enabled'] === true) { ?>
											...
											<li><a href="https://discord.gg/29j2wDy"><b><font color="red">Discord</font></b></a></li>
									<?php //} ?>
                        	</ul>
						</div>
					</div>
					...
					<div class="content_bg">
						<div class="content">
							<div class="rise-up-content" style="min-height: 150px;">
								<div class="fb-page" style="padding: 10px 47px;" data-href="https://www.facebook.com/CarcooIzx" data-width="500" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false"><blockquote cite="https://www.facebook.com/CarcooIzx" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/CarcooIzx">CarcooIzx OT</a></blockquote></div>
							</div>
						</div>
					</div>
					<div class="border_bottom"></div>
