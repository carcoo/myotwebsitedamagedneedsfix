...
if (isset($_GET['name']) === true && empty($_GET['name']) === false) 
{
	...
	{	
		...
		{
			$profile_data = user_character_data($user_id, 'account_id', 'town_id', 'name', 'level', 'group_id', 'vocation', 'health', 'healthmax', 'experience', 'mana', 'manamax', 'sex', 'lastlogin', 'looktype', 'lookhead', 'lookbody', 'looklegs', 'lookfeet', 'lookaddons', 'exphist1', 'exphist2', 'exphist3', 'exphist4', 'exphist5', 'exphist6', 'exphist7');
		...
		{
			$profile_data = user_character_data($user_id, 'name', 'account_id', 'town_id', 'level', 'group_id', 'vocation', 'health', 'healthmax', 'experience', 'mana', 'manamax', 'lastlogin', 'online', 'sex', 'looktype', 'lookhead', 'lookbody', 'looklegs', 'lookfeet', 'lookaddons', 'exphist1', 'exphist2', 'exphist3', 'exphist4', 'exphist5', 'exphist6', 'exphist7');
		}
		...
		<tr><th colspan="3">Character Information</th></tr>
				...
				{ 
					 echo '<img src="http://flag.znote.eu/' . $account_data['flag'] . '.png">'; 
				...
				<div style="position:relative; left:-25px; top:-48px;">
					<div style="background-image: url(layout/outfitter/outfit.php?id='.$profile_data['looktype'].'&addons='.$profile_data['lookaddons'].'&head='.$profile_data['lookhead'].'&body='.$profile_data['lookbody'].'&legs='.$profile_data['looklegs'].'&feet='.$profile_data['lookfeet'].');
