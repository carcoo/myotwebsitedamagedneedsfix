...
?>
	...
	<?php
	$record = mysql_select_single('SELECT * FROM `players_online` ORDER BY `player_id` DESC LIMIT 1;');
	?>
	<table cellpadding="4">
		<tr>
			<th>
		...
		<tr>
			<td>
				Currently <strong><?php echo user_count_online(); ?></strong> players are online on <strong><?php echo $config['site_title']; ?>
			</td>
		</tr>
	</table>
<?php
