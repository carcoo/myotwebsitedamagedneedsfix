<?php
	...
	$config['site_title'] = 'CarcooIzx OT';
	$config['site_title_context'] = 'Welcome in CarcooIzx OT';
	$config['site_url'] = "http://carcooizx.zapto.org";

	// Path to server folder without / Example: C:\Users\Alvaro\Documents\GitHub\forgottenserver
	$config['server_path'] = '/var/CarcooIzx/'; 
	...
	$config['sqlPassword'] = '5039642Ilovenazly$';

	// The database name to connect to. (This is usually same as username).
	$config['sqlDatabase'] = 'carcoo';
	...
	function getClock($time = true, $format = false, $adjust = true) {
	...
	*/
	...
	$config['create_guild_level'] = 10000;
	...
	$config['gameserver'] = array(
		'ip' => 'carcooizx.zapto.org',
		'port' => 7172,
		'name' => 'CarcooIzx' // Must be identical to config.lua (OT config file) server name.
	);
	...
	*/
	$config['mailserver'] = array(
		...
		'host' => "mailserver.carcoo.zapto.org", // Outgoing mail server host.
		'securityType' => 'ssl', // ssl or tls
		'port' => 465, // SMTP port number - likely to be 465(ssl) or 587(tls)
		'email' => 'noreply@carcooizx.zapto.org', 
		'username' => 'noreply@carcooizx.zapto.org', // Likely the same as email
	...
	$config['captcha_site_key'] = "6LfVUl8UAAAAACun_YtjcNR_ObnvKrXInxO8uRJK";
	$config['captcha_secret_key'] = "6LfVUl8UAAAAAHuUJiKp4FXjp1Mbf1WSju3PHHia";
	...
	*/
	...
	$config['paypal'] = array(
		'enabled' => true,
		'email' => 'abdo.mistro@gmail.com', // Example: paypal@mail.com
		'currency' => 'USD',
		'points_per_currency' => 500, // 1 currency = ? points? [ONLY used to calculate bonuses]
	...
	$config['shop_auction'] = array(
		...
		'requiredLevel' => 50000, // Minimum level of sold character
		'leastValue' => 500, // Lowest donation points a char can be sold for.
	...
	*/
	$config['shop_offers'] = array(
		1 => array(
			...
			'count' => 10, // Stack number (5x itemid)
			'description' => "<b>Gold Bars</b>", // Description shown on website
		...
		2 => array(
			...
			'itemid' => 18403,
			'count' => 1,
			'description' => "<b>Donation Helmet<br><font color=red>Protection All = 7%<br>Arm:5000</font></b>",
			'points' => 1200,
		),
		3 => array(
			'type' => 1,
			'itemid' => 18404,
			'count' => 1,
			'description' => "<b>Donation Armor<br><font color=red>Protection All = 7%<br>Arm:5000</font></b>",
			'points' => 1200,
		),
		4 => array(
			'type' => 1,
			'itemid' => 18405,
			'count' => 1,
			'description' => "<b>Donation Legs<br><font color=red>Protection All = 7%<br>Arm:5000</font></b>",
			'points' => 1200,
		),
		5 => array(
			'type' => 1,
			'itemid' => 18406,
			'count' => 1,
			'description' => "<b>Donation Boots<br><font color=red>Protection All = 7%<br>Arm:5000</font></b>",
			'points' => 1200,
		),
		6 => array(
			'type' => 1,
			'itemid' => 18410,
			'count' => 1,
			'description' => "<b>Donation Shield<br><font color=red>Protection All = 7%<br>Def:10000</font></b>",
			'points' => 1200,
		),
		7 => array(
			'type' => 1,
			'itemid' => 12645,
			'count' => 1,
			'description' => "<b>Ultra Donation Helmet<br><font color=red>Protection All = 10%<br>Arm:7500</font><br><font color=green>(Best Helmet)</font></b>",
			'points' => 2000,
		),
		8 => array(
			'type' => 1,
			'itemid' => 12642,
			'count' => 1,
			'description' => "<b>Ultra Donation Armor<br><font color=red>Protection All = 10%<br>Arm:7500</font><br><font color=green>(Best Armor)</font></b>",
			'points' => 2000,
		),
		9 => array(
			'type' => 1,
			'itemid' => 12643,
			'count' => 1,
			'description' => "<b>Ultra Donation Legs<br><font color=red>Protection All = 10%<br>Arm:7500</font><br><font color=green>(Best Legs)</font></b>",
			'points' => 2000,
		),
		10 => array(
			'type' => 1,
			'itemid' => 12646,
			'count' => 1,
			'description' => "<b>Ultra Donation Boots<br><font color=red>Protection All = 10%<br>Arm:7500</font><br><font color=green>(Best Boots)</font></b>",
			'points' => 2000,
		),
		11 => array(
			'type' => 1,
			'itemid' => 12644,
			'count' => 1,
			'description' => "<b>Ultra Donation Shield<br><font color=red>Protection All = 10%<br>Def:15000</font><br><font color=green>(Best Shield)</font></b>",
			'points' => 2000,
		),
		12 => array(
			'type' => 1,
			'itemid' => 2270, 
			'count' => 1,
			'description' => "<b>Donation Pally Rune<br><font color=red>This rune heals you with 500k mana and heals HP (depends on your level).</font></b>",
			'points' => 1000,
		),
		13 => array(
			'type' => 1,
			'itemid' => 2297, 
			'count' => 1,
			'description' => "<b>Donation Manarune<br><font color=red>This rune heals you with 700k mana.</font></b>",
			'points' => 1000,
		),
		14 => array(
			'type' => 1,
			'itemid' => 2299, 
			'count' => 1,
			'description' => "<b>Donation UH<br><font color=red>This rune heals you HP (depends on your level).</font></b>",
			'points' => 1000,
		),
		15 => array(
			'type' => 1,
			'itemid' => 2307, 
			'count' => 1,
			'description' => "<b>Donation SD<br><font color=red>This is the best SD in CarcooIzx It deals DMG Depending on your level.<br> Note: It's Powerful.</font></b>",
			'points' => 2000,
		),
		16 => array(
			'type' => 7,
			'itemid' => 16101, 
			'count' => 1,
			'description' => "<b>Vip Scroll<br><font color=red>This scroll gives you 30 days of access to VIP area and 2x exp rate.<br></font></b>",
			'points' => 6000,
		),
		17 => array(
			'type' => 7,
			'itemid' => 21555, 
			'count' => 1,
			'description' => "<b>Looter Scroll<br><font color=red>This scroll gives you 5 days of auto looting.<br></font></b>",
			'points' => 5000,
		),
		18 => array(
			'type' => 7,
			'itemid' => 25423, 
			'count' => 1,
			'description' => "<b>Forever Amulet Of Loss<br><font color=red>This amulet is infinite (doesn't prevent items loss on red/black skull).<br></font></b>",
			'points' => 500,
		),
		19 => array(
			'type' => 7,
			'itemid' => 26131, 
			'count' => 1,
			'description' => "<b>Skull Amulet Of Loss<br><font color=red>This amulet is infinite and prevents items loss on red/black skull.<br></font></b>",
			'points' => 4000,
		),
		20 => array(
			'type' => 4,
			'itemid' => 7724, 
			'count' => 1,
			'description' => "<b>Name Changer<br><font color=red>Changing your name<br></font></b>",
			'points' => 4000,
		),
		21 => array(
			'type' => 1,
			'itemid' => 25942, 
			'count' => 1,
			'description' => "<b>Ultra Donation Club<br><font color=red>This is the most powerful club in the game : Ultra Donation Club (Atk:15000, club fighting +5, critical hit chance +4, critical hit damage +70, life leech chance +4, life leech amount +35, mana leech chance +4, mana leech amount +35).<br></font></b>",
			'points' => 5000,
		),
		22 => array(
			'type' => 1,
			'itemid' => 25922, 
			'count' => 1,
			'description' => "<b>Ultra Donation Blade<br><font color=red>This is the most powerful sword in the game : Ultra Donation Blade (Atk:15000, sword fighting +5, critical hit chance +4, critical hit damage +70, life leech chance +4, life leech amount +35, mana leech chance +4, mana leech amount +35).<br></font></b>",
			'points' => 5000,
		),
		23 => array(
			'type' => 1,
			'itemid' => 25934, 
			'count' => 1,
			'description' => "<b>Ultra Donation Axe<br><font color=red>This is the most powerful axe in the game : Ultra Donation Axe (Atk:15000, axe fighting +5, critical hit chance +4, critical hit damage +70, life leech chance +4, life leech amount +35, mana leech chance +4, mana leech amount +35).<br></font></b>",
			'points' => 5000,
		),
		24 => array(
			'type' => 1,
			'itemid' => 25958, 
			'count' => 1,
			'description' => "<b>Ultra Donation Rod<br><font color=red>This is the most powerful rod in the game : Ultra Donation Rod (critical hit chance +4, critical hit damage +70, life leech chance +4, life leech amount +35, mana leech chance +4, mana leech amount +35, magic level +8).<br></font></b>",
			'points' => 5000,
		),
		25 => array(
			'type' => 1,
			'itemid' => 25954, 
			'count' => 1,
			'description' => "<b>Ultra Donation Wand<br><font color=red>This is the most powerful Wand in the game : Ultra Donation Wand (critical hit chance +4, critical hit damage +70, life leech chance +4, life leech amount +35, mana leech chance +4, mana leech amount +35, magic level +8).<br></font></b>",
			'points' => 5000,
		),
		26 => array(
			'type' => 1,
			'itemid' => 25950, 
			'count' => 1,
			'description' => "<b>Ultra Donation Crossbow(No Ammo)<br><font color=red>This is the most powerful distance weapon in the game : Ultra Donation Crossbow (Atk:15000, distance fighting +5, critical hit chance +4, critical hit damage +70, life leech chance +4, life leech amount +35, mana leech chance +4, mana leech amount +35).<br></font></b>",
			'points' => 5000,
		),
		27 => array(
			'type' => 1,
			'itemid' => 25914, 
			'count' => 1,
			'description' => "<b>Donation Club<br><font color=red>This is the second most powerful club in the game : Donation Club (Atk:10000, club fighting +3, critical hit chance +3, critical hit damage +50, life leech chance +3, life leech amount +25, mana leech chance +3, mana leech amount +25).<br></font></b>",
			'points' => 3500,
		),
		28 => array(
			'type' => 1,
			'itemid' => 25909, 
			'count' => 1,
			'description' => "<b>Donation Blade<br><font color=red>This is the second most powerful sword in the game : Donation Blade (Atk:10000, Sword fighting +3, critical hit chance +3, critical hit damage +50, life leech chance +3, life leech amount +25, mana leech chance +3, mana leech amount +25).<br></font></b>",
			'points' => 3500,
		),
		29 => array(
			'type' => 1,
			'itemid' => 25912, 
			'count' => 1,
			'description' => "<b>Donation Axe<br><font color=red>This is the second most powerful axe in the game : Donation Axe (Atk:10000, axe fighting +3, critical hit chance +3, critical hit damage +50, life leech chance +3, life leech amount +25, mana leech chance +3, mana leech amount +25).<br></font></b>",
			'points' => 3500,
		),
		30 => array(
			'type' => 1,
			'itemid' => 25918, 
			'count' => 1,
			'description' => "<b>Donation Rod<br><font color=red>This is the second most powerful rod in the game : Donation Rod (critical hit chance +3, critical hit damage +50, life leech chance +3, life leech amount +25, mana leech chance +3, mana leech amount +25, magic level +5).<br></font></b>",
			'points' => 3500,
		),
		31 => array(
			'type' => 1,
			'itemid' => 25917, 
			'count' => 1,
			'description' => "<b>Donation Wand<br><font color=red>This is the second most powerful Wand in the game : Donation Wand(critical hit chance +3, critical hit damage +50, life leech chance +3, life leech amount +25, mana leech chance +3, mana leech amount +25, magic level +5).<br></font></b>",
			'points' => 3500,
		),
		32 => array(
			'type' => 1,
			'itemid' => 25916, 
			'count' => 1,
			'description' => "<b>Donation Crossbow(No Ammo)<br><font color=red>This is the second most powerful distance weapon in the game : Donation Crossbow (Atk:10000, distance fighting +3, critical hit chance +3, critical hit damage +50, life leech chance +3, life leech amount +25, mana leech chance +3, mana leech amount +25).<br></font></b>",
			'points' => 3500,
		),
		33 => array(
			'type' => 1,
			'itemid' => 26187, 
			'count' => 1,
			'description' => "<b>Donation Ring<br><font color=red>This is the second most powerful ring in the game : Donation Ring (club fighting +7, sword fighting +7, axe fighting +7, distance fighting +7, magic level +3, protection all +3%).<br>This ring heals you with 75k(MP/HP) per second. ( All vocations can use the ring to turn on the forever utamo EXCEPT KNIGHTS! )</font></b>",
			'points' => 2000,
		),
		34 => array(
			'type' => 1,
			'itemid' => 26189, 
			'count' => 1,
			'description' => "<b>Ultra Donation Ring<br><font color=red>This is the most powerful ring in the game : Ultra Donation Ring (club fighting +10, sword fighting +10, axe fighting +10, distance fighting +10, magic level +5, protection all +5%).<br>This ring heals you with 100k(MP/HP) per second. ( All vocations can use the ring to turn on the forever utamo EXCEPT KNIGHTS! )</font></b>",
			'points' => 4000,
			),
		35 => array(
			'type' => 7,
			'itemid' => 26201, 
			'count' => 1,
			'description' => "<b>Store Coins<br><font color=red>By using this powder you will have 100 coins in-game store!.</font></b>",
			'points' => 1500,
		),
		36 => array(
			'type' => 7,
			'itemid' => 12466, 
			'count' => 1,
			'description' => "<b>SVIP Scroll<br><font color=red>By using this scroll you will take x4 EXP rate and access to vip area or 5 days!.</font></b>",
			'points' => 10000,
		),
		37 => array(
			'type' => 7,
			'itemid' => 26143, 
			'count' => 1,
			'description' => "<b><font color=red>SVIP Scroll [LIMITED]</font><br><font color=red>By using this scroll you will take x4 EXP rate and access to vip area or 15 days!.[Limited Edition]</font></b>",
			'points' => 25000,
		),
		101 => array(
			'type' => 6,
			'itemid' => 37,
			'count' => 1,
			'description' => "Armoured Dragonling",
			'points' => 8000,
		),
	);
?>
